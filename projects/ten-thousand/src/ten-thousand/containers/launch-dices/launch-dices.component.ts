...
export class LaunchDicesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if ( (this.dices.includes(1) && this.dices.includes(2) && this.dices.includes(3) && this.dices.includes(4) && this.dices.includes(5))
        || (this.dices.includes(2) && this.dices.includes(3) && this.dices.includes(4) && this.dices.includes(5) && this.dices.includes(6) )
        ){
            this.score += 1500
